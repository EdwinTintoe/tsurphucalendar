...
Framework7.use([DeviceModule, SupportModule, UtilsModule, ResizeModule, TouchModule, ClicksModule, RouterModule, HistoryModule, ComponentModule, ServiceWorkerModule, StoreModule, Statusbar, View, Navbar, Toolbar, Subnavbar, TouchRipple, Modal, Popup, Popover, Sheet, Toast, Preloader, Accordion, Panel, Grid, Fab, Swiper, Notification, Typography]);
